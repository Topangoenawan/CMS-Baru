...
function buka_form ($link, $id, $aksi) {
    echo'
    <form method="GET" action="'.$link.'&show=action" class="form-horizontal me-5" enctype="multipart/form-data">
    <input type="hidden" name="id" value="'.$id.'">
    <input type="hidden" name="aksi" value="'.$aksi.'">
    ';
}

function buat_textbox($label, $nama, $nilai, $lebar='6', $tipe="text", $disabled=""){
    echo'
    <div class="form-group id="'.$nama.'">
        <label for="'.$nama.'" class="col-md-2 control-label">'.$label.'</label>
...
function buat_password($label, $nama, $nilai, $lebar='6', $tipe="password", $disabled=""){
    echo'
    <div class="form-group id="'.$nama.'">
        <label for="'.$nama.'" class="col-md-2 control-label">'.$label.'</label>
        <div class= "col-sm-10 mb-3 d-flex justify-content-center">
